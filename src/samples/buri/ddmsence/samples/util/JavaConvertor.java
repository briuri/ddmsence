...
public class JavaConvertor {
	...
	public static String toJavaCode(Resource r) {
		...
		java.append("Resource resource = new Resource(topLevelComponents, ").append(r.isResourceElement()).append(", \"")
			.append(r.getCreateDate().toXMLFormat()).append("\", new Integer(").append(r.getDESVersion().intValue()).append("), ")
