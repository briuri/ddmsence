 ...
 * @since 0.9.b
 */
public final class Organization extends AbstractProducer {
	...
	public Organization(String producerType, List<String> names, List<String> phones, List<String> emails,
		...
		super(producerType, Organization.NAME, names, phones, emails, securityAttributes, extensions, true);
	}
	...
	public static class Builder extends AbstractProducer.Builder {
		...
		public Organization commit() throws InvalidDDMSException {
			return (isEmpty() ? null : new Organization(getProducerType(), getNames(), getPhones(), getEmails(), 
