 ...
 * <u>Description</u>: The access value for a profile.<br />
...
public final class ProfileValue extends AbstractNtkString {
	...
	public ProfileValue(String value, String vocabulary, String id, String idReference, String qualifier,
		...
		try {
			if (!Util.isEmpty(vocabulary))
				Util.addAttribute(getXOMElement(), PropertyReader.getProperty("ntk.prefix"), VOCABULARY_NAME,
	...
	public String getOutput(boolean isHTML, String prefix) {
		prefix = Util.getNonNullString(prefix) + "profileValue";
		StringBuffer text = new StringBuffer();
		text.append(buildOutput(isHTML, prefix, getValue(), false));
		text.append(buildOutput(isHTML, prefix + ".vocabulary", getVocabulary(), true));
