...
public class SRSAttributesTest extends AbstractComponentTestCase {
	 ...
	 * @return a valid object
	 */
	private SRSAttributes testConstructor(boolean expectFailure, String srsName, Integer srsDimension, List<String> axisLabels, 
	 ...
	 * @param uomLabels the labels for UOM (required when axisLabels is set)
	 */
	private void addAttributes(Element element, String srsName, Integer srsDimension, String axisLabels, String uomLabels) {
		Util.addAttribute(element, SRSAttributes.NO_PREFIX, "srsName", SRSAttributes.NO_NAMESPACE, srsName);
		if (srsDimension != null)
			Util.addAttribute(element, SRSAttributes.NO_PREFIX, "srsDimension", SRSAttributes.NO_NAMESPACE, String.valueOf(srsDimension));
	...
	public void testElementConstructorValid() {
		// All fields
		Element element = Util.buildElement(GML_PREFIX, Position.NAME, DDMSVersion.getCurrentVersion().getGmlNamespace(), null);
		...
		// No optional fields
		element = Util.buildElement(GML_PREFIX, Position.NAME, DDMSVersion.getCurrentVersion().getGmlNamespace(), null);
		testConstructor(WILL_SUCCEED, element);		
	}
	...
	public void testConstructorInequalityDifferentValues() {
		...
		dataAttributes = testConstructor(WILL_SUCCEED, TEST_SRS_NAME, TEST_SRS_DIMENSION, newLabels, TEST_UOM_LABELS);
		assertFalse(elementAttributes.equals(dataAttributes));
