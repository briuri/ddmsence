...
public class LinkTest extends AbstractComponentTestCase {
	...
	protected static Element getFixtureElement() throws InvalidDDMSException {
		...
		linkElement.addNamespaceDeclaration(Util.DDMS_PREFIX, DDMSVersion.getDefaultNamespace());
	...
	private String getExpectedXMLOutput() {
		...
		xml.append("<ddms:link xmlns:ddms=\"").append(DDMS_NAMESPACE).append("\" xmlns:xlink=\"").append(XLINK_NAMESPACE).append("\" ");
	...
	public void testElementConstructorValid() throws InvalidDDMSException {
		...
		element.addNamespaceDeclaration(Util.DDMS_PREFIX, DDMSVersion.getDefaultNamespace());
