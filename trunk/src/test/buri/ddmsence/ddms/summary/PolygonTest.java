...
public class PolygonTest extends AbstractComponentTestCase {
	...
	private Element wrapPositions(List<Position> positions) {
		Element ringElement = Util.buildElement(GML_PREFIX, "LinearRing", DDMSVersion.getCurrentVersion().getGmlNamespace(), null);
		for (Position pos : positions) {
			ringElement.appendChild(pos.getXOMElementCopy());
		}
		Element extElement = Util.buildElement(GML_PREFIX, "exterior", DDMSVersion.getCurrentVersion().getGmlNamespace(), null);
	...
	public void testElementConstructorValid() {
		...
		// No optional fields
		Element element = Util.buildElement(GML_PREFIX, Polygon.NAME, DDMSVersion.getCurrentVersion().getGmlNamespace(), null);
