...
public class MediaExtentTest extends AbstractComponentTestCase {
	...
	private String getExpectedXMLOutput() {
		...
		xml.append("<ddms:extent xmlns:ddms=\"").append(DDMSVersion.getCurrentNamespace()).append("\" ");
	...
	public void testConstructorEquality() {
		MediaExtent elementComponent = testConstructor(WILL_SUCCEED, getValidElement());
