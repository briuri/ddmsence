...
public class LanguageTest extends AbstractComponentTestCase {
	...
	private String getExpectedXMLOutput() {
		...
		xml.append("<ddms:language xmlns:ddms=\"").append(DDMSVersion.getCurrentNamespace()).append("\" ");
	...
	public void testNameAndNamespace() {
		...
		assertEquals(Util.DDMS_PREFIX + ":" + Language.NAME, component.getQualifiedName());
