...
public class ProfileValueTest extends AbstractComponentTestCase {
	...
	public void testConstructorEquality() {
		for (String versionString : DDMSVersion.getSupportedVersions()) {
			...
			ProfileValue dataComponent = testConstructor(WILL_SUCCEED, TEST_VALUE, TEST_VOCABULARY, TEST_ID, TEST_ID_REFERENCE, TEST_QUALIFIER);
	...
	public void testConstructorInequalityDifferentValues() {
		for (String versionString : DDMSVersion.getSupportedVersions()) {
			...
			ProfileValue elementComponent = testConstructor(WILL_SUCCEED, getValidElement(versionString));
			ProfileValue dataComponent = testConstructor(WILL_SUCCEED, DIFFERENT_VALUE, TEST_VOCABULARY, TEST_ID, TEST_ID_REFERENCE, TEST_QUALIFIER);
			assertFalse(elementComponent.equals(dataComponent));
			
			dataComponent = testConstructor(WILL_SUCCEED, TEST_VALUE, DIFFERENT_VALUE, TEST_ID, TEST_ID_REFERENCE, TEST_QUALIFIER);
			assertFalse(elementComponent.equals(dataComponent));
						
			dataComponent = testConstructor(WILL_SUCCEED, TEST_VALUE, TEST_VOCABULARY, DIFFERENT_VALUE, TEST_ID_REFERENCE, TEST_QUALIFIER);
			assertFalse(elementComponent.equals(dataComponent));
			
			dataComponent = testConstructor(WILL_SUCCEED, TEST_VALUE, TEST_VOCABULARY, TEST_ID, DIFFERENT_VALUE, TEST_QUALIFIER);
			assertFalse(elementComponent.equals(dataComponent));
			
			dataComponent = testConstructor(WILL_SUCCEED, TEST_VALUE, TEST_VOCABULARY, TEST_ID, TEST_ID_REFERENCE, DIFFERENT_VALUE);
			assertFalse(elementComponent.equals(dataComponent));			
		}
	}
	...
	public void testHTMLOutput() throws InvalidDDMSException {
		for (String versionString : DDMSVersion.getSupportedVersions()) {
			...
			component = testConstructor(WILL_SUCCEED, TEST_VALUE, TEST_VOCABULARY, TEST_ID, TEST_ID_REFERENCE, TEST_QUALIFIER);
			assertEquals(getExpectedOutput(true), component.toHTML());
		}
	}
