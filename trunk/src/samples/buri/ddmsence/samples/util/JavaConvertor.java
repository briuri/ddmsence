...
public class JavaConvertor {
	...
	public static String toJavaCode(Resource r) {
		...
		java.append("DDMSVersion.setCurrentVersion(\"")
			.append(DDMSVersion.getVersionForDDMSNamespace(r.getNamespace())).append("\");\n");
	...
	public static void convert(StringBuffer java, Type type) {
		...
		java.append("Type type").append(count).append(" = new Type(\"").append(type.getDescription()).append("\", \"")
			.append(type.getQualifier()).append("\", \"").append(type.getValue()).append("\", securityAttributes);\n");
	...
	public static void convert(StringBuffer java, int count, GeographicIdentifier geoId) {
		if (geoId.hasFacilityIdentifier()) {
			...
			if (geoId.getSubDivisionCode() != null)
				java.append("new SubDivisionCode(\"").append(geoId.getSubDivisionCode().getQualifier())
					.append("\", \"").append(geoId.getSubDivisionCode().getValue()).append("\"));\n");
			else
				java.append("null);\n");
		}
	}
