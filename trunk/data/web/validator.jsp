...
public class ValidatorRecord {
	...
	<li>The <a href="https://code.urizone.net/svn/ddmsence/trunk/data/web/validator.jsp">initial form view</a> is rendered. This is the page you are currently viewing. The JSP file also contains the JavaScript code used for client-side validation (with jQuery).</li>
	...
	is then used to render the <a href="https://code.urizone.net/svn/ddmsence/trunk/data/web/validatorResult.jsp">Validation Results page</a>.</li>
</ol>	
