...
<p class="figure">Figure 13. An XML fragment containing Subject Coverage information</p>
...
<p class="figure">Figure 14. The "bottoms-up" approach for building a SubjectCoverage component</p>
...
<p class="figure">Figure 15. The Builder approach for building a SubjectCoverage component</p>
...
<p class="figure">Figure 16. Programatically editing a batch of Resources</p>
...
one does not already exist. An example of this can be seen on line 2 of Figure 15: When the value of the Keyword is set to "DDMSence", the List of Keyword.Builders
...
<p class="figure">Figure 17. Transforming a DDMS 2.0 resource with the Builder Framework</p>
...
of DDMS you are employing. The sample files described above are written only for DDMS 4.0.</p>
