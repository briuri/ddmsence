...
cd &lt;<i>folderWhereDDMSenceIsUnzipped</i>&gt;\ddmsence-bin-1.2.1
...
set DDMSENCE_CLASSPATH=%DDMSENCE_CLASSPATH%;lib/ddmsence-1.2.1.jar;lib/ddmsence-samples-1.2.1.jar;classes/
...
ddmsence_classpath=$ddmsence_classpath:lib/ddmsence-1.2.1.jar:lib/ddmsence-samples-1.2.1.jar:classes/
java -cp $ddmsence_classpath buri.ddmsence.samples.Essentials</pre></div>
