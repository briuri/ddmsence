...
cd &lt;<i>folderWhereDDMSenceIsUnzipped</i>&gt;\ddmsence-bin-1.3.2
...
set DDMSENCE_CLASSPATH=%DDMSENCE_CLASSPATH%;lib/ddmsence-1.3.2.jar;lib/ddmsence-samples-1.3.2.jar;classes/
...
ddmsence_classpath=$ddmsence_classpath:lib/ddmsence-1.3.2.jar:lib/ddmsence-samples-1.3.2.jar:classes/
java -cp $ddmsence_classpath buri.ddmsence.samples.Essentials</pre></div>
...
<div class="example"><pre>PropertyReader.setProperty("icism.prefix", "ic");</pre></div>
