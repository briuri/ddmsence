...
cd &lt;<i>folderWhereDDMSenceIsUnzipped</i>&gt;\ddmsence-bin-1.2.0
set DDMSENCE_CLASSPATH=lib/xercesImpl-2.9.1.jar;lib/xml-apis-1.3.04.jar;lib/xom-1.2.4.jar
set DDMSENCE_CLASSPATH=%DDMSENCE_CLASSPATH%;lib/ddmsence-1.2.0.jar;lib/ddmsence-samples-1.2.0.jar;classes/
...
ddmsence_classpath=$ddmsence_classpath:lib/ddmsence-1.2.0.jar:lib/ddmsence-samples-1.2.0.jar:classes/
java -cp $ddmsence_classpath buri.ddmsence.samples.Essentials</pre></div>
