...
public class BuilderControl extends AbstractControl {
	...
	<li>If the Builder succeeds, the Resource is proven to be valid, although there may still be warnings. The warnings and the XML output of the Resource are stored in the model,	which is then used to render the <a href="https://github.com/briuri/ddmsence/blob/master/data/web/builderResult.jsp">Builder Results page</a>.</li>
</ol>
