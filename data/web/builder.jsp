...
<head>
	...
	<title>Online DDMS Builder  | DDMSence</title>
...
public class BuilderControl extends AbstractControl {
	...
	<li>The <a href="https://code.urizone.net/svn/ddmsence/trunk/data/web/builder.jsp">initial form view</a> is rendered. This is the page 
	...
	<li>If the Builder succeeds, the Resource is proven to be valid, although there may still be warnings. The warnings and the XML output of the Resource are stored in the model,	which is then used to render the <a href="https://code.urizone.net/svn/ddmsence/trunk/data/web/builderResult.jsp">Builder Results page</a>.</li>
</ol>
